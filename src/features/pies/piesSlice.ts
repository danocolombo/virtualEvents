...
export const getPieInventory = (state: RootState) => state.pies.inventory;
export const getPiesStatus = (state: RootState) => state.pies.status;
...
export const incrementPiesIfOdd =
    ...
    (dispatch, getState) => {
        const currentValue = getPieInventory(getState());
        if (currentValue % 2 === 1) {
